...
/* Fonte locale dei contenuti della Security Guide.
   object è un singleton che garantisce una sola istanza della raccolta statica e mantiene
   separati i dati dalla UI dell'Activity */
object SecurityGuideRepository {

    // List immutabile: i contenuti della guida non vengono modificati a runtime.
    val items: List<SecurityGuideItem> = listOf(

        SecurityGuideItem(
            title = "Password Security",
            explanation =
                "Una password efficace deve essere difficile da indovinare " +
                        "e diversa per ogni servizio.",
            tips = listOf(
        ...
        SecurityGuideItem(
            title = "Phishing",
            explanation =
                "Il phishing cerca di convincerti a fornire informazioni " +
                        "riservate attraverso messaggi o pagine contraffatte.",
            tips = listOf(
                "Controlla con attenzione il mittente del messaggio.",
        ...
        SecurityGuideItem(
            ...
            explanation =
                "Un link può nascondere una destinazione diversa da quella " +
                        "che sembra indicare.",
            tips = listOf(
                "Controlla il dominio principale dell'URL.",
        ...
        SecurityGuideItem(
            title = "HTTPS / TLS",
            explanation =
                "HTTPS protegge la comunicazione tra dispositivo e server " +
        ...
        SecurityGuideItem(
            ...
            explanation =
                "Android applica diversi livelli di protezione, tra cui " +
                        "sandbox, permessi e isolamento dei processi.",
            tips = listOf(
                "La sandbox limita l'accesso di un'app alle risorse di altre app.",
        ...
        SecurityGuideItem(
            ...
            explanation =
                "La sicurezza quotidiana dipende da più comportamenti semplici " +
                        "applicati insieme.",
            tips = listOf(
                "Mantieni aggiornati sistema operativo e applicazioni.",
                "Utilizza MFA quando disponibile.",
